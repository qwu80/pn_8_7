        ...
        if (this.color == 0){
            ...
            if (sceneCount ==2) {
             ...
             if (this.origin.x == 0 && this.origin.y == 0) {
                ...
                strokeWeight(1);
                ellipse(this.position.x,-7+(k+144)*s_y+this.botz*(-array_band_hardcode[99]-array_band_hardcode[0])*0.3,5)
             } else {
                noFill();
                stroke(125, 241, 148,  100); //green
                strokeWeight(1);
                ellipse(this.position.x,-7+(this.origin.y-155.7)+(k+144+16)*s_y+this.botz*(-array_band_hardcode[99]-array_band_hardcode[0])*0.3,5)
                // ellipse(this.position.x,((this.origin.x-line_yellow[99][1])-array_band2[99]+array_band_hardcode[99]+75-array_band_hardcode[99]-this.botz*(-array_band_hardcode[99]-array_band_hardcode[0])*0.3)*s_y,5)
